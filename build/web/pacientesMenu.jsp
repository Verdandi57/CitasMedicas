...
<html>
    ...
    <body style="background-image: url('WEB-IMG/wallpaper2.jpg'); background-repeat: no-repeat; background-size: cover;">
        <div class="container-fluid bg">
            ...
            <div class="row">
                ...
                <div class="col-8 form-control">
                    <br/>
                    <h4 style="text-align: center">Menu Pacientes</h4>
                    <br/>
                    <br/>
                    <div>
                        <html:form action="/PacientesAction">
                            <ul>
                                <li>
                                    <a class="btn btn-link btn-secondary" href="ingresarpaciente.jsp">Agregar</a>
                                </li>
                                <br/>
                                <li><html:submit property="action" value="consultar todo" styleClass="btn btn-link btn-secondary"/>
                                </li>
                            </ul>
