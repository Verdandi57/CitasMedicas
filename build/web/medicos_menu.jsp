...
<html>
    <head>
        ...
        <script src="bootstrap-4.1.2-dist/js/jquery-3.3.1.min.js" type="text/javascript"></script>
        <script src="bootstrap-4.1.2-dist/js/popper.min.js" type="text/javascript"></script>
        ...
        <div class="container-fluid bg">
            ...
            <div class="row">
                ...
                <div class="col-8 form-control">
                    ...
                    <br/>
                    <ul>
                        <li><a class="btn btn-link btn-secondary" href="usuarios_form.jsp">Añadir</a></li>
                        <br/>
                        <li><a class="btn btn-link btn-secondary" href="">Mostrar</a></li>
                    </ul>
